...
_sage_const_300 = Integer(300); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20); _sage_const_80 = Integer(80); _sage_const_1000 = Integer(1000); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_30 = Integer(30); _sage_const_10000 = Integer(10000); _sage_const_192 = Integer(192); _sage_const_4092 = Integer(4092); _sage_const_4093 = Integer(4093); _sage_const_8p87 = RealNumber('8.87')##################################################
# RING-LWE ATTACK #
##################################################
...
# # gọi hàm ví dụ
# f(1) mod q = 0
f = y**_sage_const_192  + _sage_const_4092     
q = _sage_const_4093  
# sigma = s/sqrt(2*pi)                 
s = _sage_const_8p87     # := w         
...
shebang(f, q, s, numsampsval=_sage_const_30 , numtrials=_sage_const_1 , quickflag=False)
